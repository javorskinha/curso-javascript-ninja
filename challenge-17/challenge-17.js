(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Andrieli Javorski'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'guarapuavano'));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/, (phrase)=> {
    ...
    */
    ...
    function getMonthNumber (month) {
        ...
        return monthTable[month.toLowerCase()];
    };
    var mes = 'Março'
