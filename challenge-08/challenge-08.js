...
desses parâmetros.
*/
const sum1 = function calculateSum(x, y){
  return x + y;
};
...
const val1 = 3;
const val2 = 5;
console.log(`A soma de ${val1} e ${val2} é igual a ${sum1(val1, val2)}.`);

/*
Mostre no console o nome da função criada acima, com a frase:
"O nome da função que faz a soma é [NOME DA FUNÇÃO]."
*/
console.log(`O nome da função que faz a soma é ${sum1.name}.`);
